...
component C
{
	...
	component D
	{
		...
		// provided port
		X(p1 : int, inout r1 : bool, p2 : int, inout r2 : bool)
		{
			Y();
			r1 = false;
			r2 = b;
	...
	// required ports
	M(p1 : int, inout r1 : bool, p2 : int, inout r2 : bool);
...
\begin{equation*}
	\faultExpr \in \FaultExpr := \trueExpr \mid \falseExpr \mid \fault \mid \negateExpr{\faultExpr} \mid
...
\begin{align*}
	\FaultExprSem{\trueExpr} \faultEnvCurried &= \true \\
	\FaultExprSem{\falseExpr} \faultEnvCurried &= \false \\
...
situations.
\begin{align*}
	\stepDecl \in \StepDecl &:= \stepDeclSyn{\behavior}{\faultExpr}
	\\
