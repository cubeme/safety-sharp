...
\newcommand{\QReqPortName}{\mathit{QualifiedReqPortName}}
\newcommand{\QProvPortName}{\mathit{QualifiedProvPortName}}
...
\newcommand{\varName}{\mathit{n_v}}
\newcommand{\reqPortName}{\mathit{n_r}}
\newcommand{\provPortName}{\mathit{n_p}}
\newcommand{\qReqPortName}{\mathit{q_r}}
\newcommand{\qProvPortName}{\mathit{q_p}}
\newcommand{\compName}{\mathit{n_c}}
\newcommand{\type}{\tau}
\newcommand{\field}{f}
\newcommand{\local}{l}
\newcommand{\reqPort}{r}
...
\newcommand{\provPortDecl}[5]{#1 \; \mathtt{:} \; \mathtt{(} #2 \mathtt{) \rightarrow (} #3 \mathtt{)} \; #4 #5}
...
\newcommand{\isDelayed}{\mathit{delayed}}
...
\newcommand{\instant}{\mathrm{instantaneous}}
\newcommand{\delayed}{\mathrm{delayed}}
