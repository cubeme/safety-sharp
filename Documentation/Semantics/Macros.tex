...
\newcommand{\guardedArrow}{\mathtt{\twoheadrightarrow}}
...
\newcommand{\compDeclSyn}[9]{\texttt{component} \; #1 \; \mathtt{\{} \; #2 \; #3 \; #4 \; #5 \; #6 \; #7 \; \mathtt{\{} \; #8 \;
#9 \; \mathtt{\}} \; \mathtt{\}}}
\newcommand{\faultDeclSyn}[4]{\texttt{fault} \; #1 \; \mathtt{\{} \; #2 \; \mathtt{step} \; \mathtt{\{} \; #3 \; #4 \; \mathtt{\}}
\; \mathtt{\}}}
