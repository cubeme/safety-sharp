...
//     Thursday, 10 April 2014, 15:34:23
//
...
namespace SafetySharp.Metamodel.Declarations
{
    ...
    public partial class ClassDeclaration : TypeDeclaration
    {
        ...
        /// <param name="namespace">The namespace the type is declared in.</param>
        /// <param name="members">The declared members of the type.</param>
        public ClassDeclaration(string name, string @namespace, ImmutableArray<MemberDeclaration> members)
        ...
        /// <param name="namespace">The namespace the type is declared in.</param>
        /// <param name="members">The declared members of the type.</param>
        public ClassDeclaration Update(string name, string @namespace, ImmutableArray<MemberDeclaration> members)
        {
    ...
    public partial class PropertyDeclaration : MemberDeclaration
    {
        ...
        public PropertyDeclaration(string name, TypeReference type, Statement getter, Statement setter)
            : base()
        {
        ...
        /// <param name="getter">The body of the property's getter.</param>
        /// <param name="setter">The body of the property's setter.</param>
        partial void Validate(string name, TypeReference type, Statement getter, Statement setter);

        /// <summary>
        ///     Replaces the name in a copy of the <see cref="PropertyDeclaration" /> instance.
        /// </summary>
        /// <param name="name">The name of the property.</param>
        public PropertyDeclaration WithName(string name)
        {
            return Update(name, Type, Getter, Setter);
        }

        /// <summary>
        ///     Replaces the type in a copy of the <see cref="PropertyDeclaration" /> instance.
        /// </summary>
        /// <param name="type">The type of the property.</param>
        ...
        /// <summary>
        ///     Replaces the getter in a copy of the <see cref="PropertyDeclaration" /> instance.
        /// </summary>
        /// <param name="getter">The body of the property's getter.</param>
        ...
        /// <summary>
        ///     Replaces the setter in a copy of the <see cref="PropertyDeclaration" /> instance.
        /// </summary>
        /// <param name="setter">The body of the property's setter.</param>
        ...
        /// <summary>
        ///     Returns a new <see cref="PropertyDeclaration" /> instance if any properties require an update.
        /// </summary>
        /// <param name="name">The name of the property.</param>
        /// <param name="type">The type of the property.</param>
        /// <param name="getter">The body of the property's getter.</param>
        /// <param name="setter">The body of the property's setter.</param>
        public PropertyDeclaration Update(string name, TypeReference type, Statement getter, Statement setter)
        {
    ...
    public partial class StateVariableDeclaration : MemberDeclaration
    {
        ...
        public StateVariableDeclaration(string name, TypeReference type)
            : base()
        {
            Validate(name, type);
            Name = name;
        ...
        /// <param name="name">The name of the state variable.</param>
        /// <param name="type">The type of the state variable.</param>
        partial void Validate(string name, TypeReference type);

        /// <summary>
        ///     Replaces the name in a copy of the <see cref="StateVariableDeclaration" /> instance.
        /// </summary>
        /// <param name="name">The name of the state variable.</param>
        public StateVariableDeclaration WithName(string name)
        {
            return Update(name, Type);
        }

        /// <summary>
        ///     Replaces the type in a copy of the <see cref="StateVariableDeclaration" /> instance.
        /// </summary>
        /// <param name="type">The type of the state variable.</param>
        ...
        /// <summary>
        ///     Returns a new <see cref="StateVariableDeclaration" /> instance if any properties require an update.
        /// </summary>
        /// <param name="name">The name of the state variable.</param>
        /// <param name="type">The type of the state variable.</param>
        public StateVariableDeclaration Update(string name, TypeReference type)
        {
...
namespace SafetySharp.Metamodel.TypeReferences
{
    ...
    public partial class InterfaceTypeReference : TypeReference
    {
        ...
        /// <summary>
        ///     Replaces the slot in a copy of the <see cref="InterfaceTypeReference" /> instance.
        /// </summary>
        /// <param name="slot">The slot of the interface declaration in the model's type information table.</param>
        ...
        /// <summary>
        ///     Returns a new <see cref="InterfaceTypeReference" /> instance if any properties require an update.
        /// </summary>
        /// <param name="slot">The slot of the interface declaration in the model's type information table.</param>
...
namespace SafetySharp.Metamodel
{
    ...
    public abstract partial class MetamodelRewriter : MetamodelVisitor<MetamodelElement>
    {
        ...
        public override MetamodelElement VisitComponentDeclaration(ComponentDeclaration componentDeclaration)
        {
            ...
            var name = componentDeclaration.Name;
            var @namespace = componentDeclaration.Namespace;
            var members = Visit(componentDeclaration.Members);
            return componentDeclaration.Update(name, @namespace, members);
        }
        ...
        public override MetamodelElement VisitPropertyDeclaration(PropertyDeclaration propertyDeclaration)
        {
            ...
            var name = propertyDeclaration.Name;
        ...
        public override MetamodelElement VisitStateVariableDeclaration(StateVariableDeclaration stateVariableDeclaration)
        {
            ...
            var name = stateVariableDeclaration.Name;
        ...
        {
            Assert.ArgumentNotNull(guardedCommandExpression, () => guardedCommandExpression);
            return guardedCommandExpression;
        }
