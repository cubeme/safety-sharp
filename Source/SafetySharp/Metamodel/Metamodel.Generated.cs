...
//     Thursday, 10 April 2014, 15:59:07
//
...
namespace SafetySharp.Metamodel
{
    ...
    public partial class Identifier : MetamodelElement
    {
        ...
        /// <summary>
        ///     Replaces the name in a copy of the <see cref="Identifier" /> instance.
        /// </summary>
        /// <param name="name">The name of the identifier.</param>
        ...
        /// <summary>
        ///     Returns a new <see cref="Identifier" /> instance if any properties require an update.
        /// </summary>
        /// <param name="name">The name of the identifier.</param>
...
namespace SafetySharp.Metamodel.Declarations
{
    ...
    public partial class ComponentDeclaration : TypeDeclaration
    {
        ...
        /// <param name="namespace">The namespace the type is declared in.</param>
        /// <param name="members">The declared members of the type.</param>
        public ComponentDeclaration(Identifier name, string @namespace, ImmutableArray<MemberDeclaration> members)
            : base(name, @namespace, members)
        {
        }
        ...
        /// <param name="namespace">The namespace the type is declared in.</param>
        /// <param name="members">The declared members of the type.</param>
        public ComponentDeclaration Update(Identifier name, string @namespace, ImmutableArray<MemberDeclaration> members)
        {
            if (Name != name || Namespace != @namespace || Members != members)
